...
```
python3 aws.py -p [путь_к_файлу] -s [имя_профиля]
```
...
```
python3 aws.py -j [путь_к_JSON_файлу] -s [имя_профиля]
```
...
```
python3 aws.py -a [путь_к_JSON_файлу (опционально)]
```
